...
filepath = "C:\\Users\\PMLS\\ML-OEL-StockEzy\\StockEzy\\StockEzyApp\\Linear Regression.pkl" #change path as per your sys
...
def dashboad_view(request, customer_id):
    if request.method == 'POST':
        ...
        print(close)
        history = History.objects.create(custid=Customers.objects.get(custid=customer_id), open=open, high=high, low=low, volume=volume, close=close)
